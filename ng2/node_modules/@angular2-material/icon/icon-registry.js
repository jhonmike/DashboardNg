...
var MdIconRegistry = (function () {
    ...
    MdIconRegistry.prototype.getSvgIconFromUrl = function (url) {
        ...
        if (this._cachedIconsByUrl.has(url)) {
            return Rx_1.Observable.of(cloneSvg(this._cachedIconsByUrl.get(url)));
        }
    ...
    MdIconRegistry.prototype.getNamedSvgIcon = function (name, namespace) {
        ...
        return Rx_1.Observable.throw(new MdIconNameNotFoundError(key));
    };
    /**
    ...
    MdIconRegistry.prototype._getSvgFromConfig = function (config) {
        if (config.svgElement) {
            ...
            return Rx_1.Observable.of(cloneSvg(config.svgElement));
        }
        else {
    ...
    MdIconRegistry.prototype._getSvgFromIconSetConfigs = function (name, iconSetConfigs) {
        ...
        if (namedIcon) {
            ...
            return Rx_1.Observable.of(namedIcon);
        }
        ...
        return Rx_1.Observable.forkJoin(iconSetFetchRequests)
